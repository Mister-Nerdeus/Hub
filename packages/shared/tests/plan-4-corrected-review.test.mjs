...
const review = JSON.parse(readFileSync(resolve(repoRoot, "packages/shared/fixtures/source-corrections/plan-4/plan-4-review.json"), "utf8"));
assert.equal(review.planId, "plan-4");
...
writePlanEvidence("305", "plan-4", review);
