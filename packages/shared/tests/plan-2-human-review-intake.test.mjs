...
test("Plan 2 missing submitted review record remains manual_review_required", () => {
  const plan = validateHumanReviewIntakeManifest(manifest()).reviewedPlans.find((entry) => entry.planId === "plan-2");
