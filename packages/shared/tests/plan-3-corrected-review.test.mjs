...
const review = JSON.parse(readFileSync(resolve(repoRoot, "packages/shared/fixtures/source-corrections/plan-3/plan-3-review.json"), "utf8"));
assert.equal(review.planId, "plan-3");
...
writePlanEvidence("304", "plan-3", review);
