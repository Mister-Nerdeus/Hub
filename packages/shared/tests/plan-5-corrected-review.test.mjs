...
const review = JSON.parse(readFileSync(resolve(repoRoot, "packages/shared/fixtures/source-corrections/plan-5/plan-5-review.json"), "utf8"));
assert.equal(review.planId, "plan-5");
...
writePlanEvidence("306", "plan-5", review);
