...
mustInclude(webDocker, "org.opencontainers.image.revision=\"boundary-door-destination-831-843\"", `${webDockerfile} must carry the boundary door destination batch revision label`);
...
mustInclude(apiDocker, "org.opencontainers.image.revision=\"boundary-door-destination-831-843\"", `${apiDockerfile} must carry the boundary door destination batch revision label`);
