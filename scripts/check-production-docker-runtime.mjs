...
mustInclude(webDocker, "org.opencontainers.image.revision=\"door-authoring-crash-hardening-669-678\"", `${webDockerfile} must carry the door-hardening batch revision label`);
...
mustInclude(apiDocker, "org.opencontainers.image.revision=\"door-authoring-crash-hardening-669-678\"", `${apiDockerfile} must carry the door-hardening batch revision label`);
