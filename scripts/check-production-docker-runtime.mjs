...
mustInclude(webDocker, "org.opencontainers.image.revision=\"split-room-authoring-679-688\"", `${webDockerfile} must carry the split-room authoring batch revision label`);
...
mustInclude(apiDocker, "org.opencontainers.image.revision=\"split-room-authoring-679-688\"", `${apiDockerfile} must carry the split-room authoring batch revision label`);
