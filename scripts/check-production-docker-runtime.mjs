...
mustInclude(webDocker, "org.opencontainers.image.revision=\"geometry-truth-repair-765-811\"", `${webDockerfile} must carry the geometry truth repair batch revision label`);
...
mustInclude(apiDocker, "org.opencontainers.image.revision=\"geometry-truth-repair-765-811\"", `${apiDockerfile} must carry the geometry truth repair batch revision label`);
