...
mustInclude(webDocker, "org.opencontainers.image.revision=\"workspace-ux-foundation-704-748\"", `${webDockerfile} must carry the workspace UX foundation batch revision label`);
...
mustInclude(apiDocker, "org.opencontainers.image.revision=\"workspace-ux-foundation-704-748\"", `${apiDockerfile} must carry the workspace UX foundation batch revision label`);
