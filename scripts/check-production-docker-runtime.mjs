...
mustInclude(webDocker, "org.opencontainers.image.revision=\"editor-assignment-ux-704-743\"", `${webDockerfile} must carry the editor/assignment UX batch revision label`);
...
mustInclude(apiDocker, "org.opencontainers.image.revision=\"editor-assignment-ux-704-743\"", `${apiDockerfile} must carry the editor/assignment UX batch revision label`);
