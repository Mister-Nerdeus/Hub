...
mustInclude(webDocker, "org.opencontainers.image.revision=\"split-room-closeout-hardening-689-693\"", `${webDockerfile} must carry the split-room closeout hardening batch revision label`);
...
mustInclude(apiDocker, "org.opencontainers.image.revision=\"split-room-closeout-hardening-689-693\"", `${apiDockerfile} must carry the split-room closeout hardening batch revision label`);
