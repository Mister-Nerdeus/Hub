...
writeCloseout(issue, {
  ...
  reviewFinding: "Doors now have persisted operational leads-to labels, explicit unknown destination support, and travel-role metadata without clinical claims.",
  status,
