...
export const workspaceUxRootScripts = {
  ...
  "check:editor-detailed-tools-advanced": "node scripts/check-editor-detailed-tools-advanced.mjs --stage final --issue 727",
...
export const workspaceUxRequiredManifestFlags = {
  ...
  workspaceUxPreflightStatus: "missing",
  fullPageWorkspaceShellStatus: "missing",
  productShellRailStatus: "missing",
  productShellRailAccessibilityStatus: "missing",
  productWorkflowStepperStatus: "missing",
  routeStepMappingStatus: "missing",
  runtimeProofAdvancedOnlyStatus: "missing",
  futureToolsHiddenNormalModeStatus: "missing",
  advancedEvidenceEntryStatus: "missing",
  productShellResponsiveLayoutStatus: "missing",
  activeFloorplanHubStatus: "missing",
  activeFloorplanCardLayoutStatus: "missing",
  floorplanThumbnailPreviewStatus: "missing",
  nextWorkflowStepCardStatus: "missing",
  simulationCopyOverclaimStatus: "missing",
  compactReadinessSummaryStatus: "missing",
  floorplanReadinessTruthStatus: "missing",
  activeFloorplanPersistenceResilienceStatus: "missing",
  editorWorkspaceLayoutStatus: "missing",
  editorWorkspaceWrapperStatus: "missing",
  editorCanvasExpansionStatus: "missing",
  editorToolbarDockingStatus: "missing",
  editorNormalToolbarExtractionStatus: "missing",
  editorUndoRedoAdvancedStatus: "missing",
  editorDetailedToolsAdvancedStatus: "missing",
  compactCanvasControlsStatus: "missing",
  editorTechnicalStatusAdvancedStatus: "missing",
  rightInspectorRemovedNormalStatus: "missing",
  editorDetailsBottomPanelStatus: "missing",
  editorDetailsNormalSectionsStatus: "missing",
  technicalInspectorFieldsAdvancedStatus: "missing",
  editorCompactValidationRowStatus: "missing",
