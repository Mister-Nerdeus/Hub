...
const stages = ["invalid-door-reproduction", "door-clamp", "invalid-door-warning", "render-no-throw", "solid-wall-door-negative"];
const checks = [];
...
function runStage(currentStage) {
  ...
  if (currentStage === "invalid-door-warning") {
    ...
    writeProofPng(`${dir}/screenshots/narrow-room-door-warning.png`, "warning");
  }
