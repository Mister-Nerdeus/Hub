...
## Summary
Completed scenario foundation readiness stage: ${stage}.
...
function updateEvidenceIndex() {
  ...
  const entry = { issue, title: `Scenario Foundation Readiness Issue ${issue}`, requiredEvidence: listFiles(issueDir).sort() };
