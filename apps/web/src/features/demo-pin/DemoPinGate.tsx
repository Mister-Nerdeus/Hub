...
export function DemoPinGate({
  ...
  return (
    <section className="demo-pin-gate" aria-labelledby="demo-pin-gate-title" data-demo-pin-state={viewModel.stateLabel.toLowerCase()}>
      <div className="demo-pin-gate__copy">
        <p className="eyebrow">Demo proceed gate</p>
      ...
      >
        ...
        <button type="submit">{viewModel.unlockLabel}</button>
