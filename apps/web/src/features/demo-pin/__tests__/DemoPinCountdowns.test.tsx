...
if (cooldownVm.countdownLabel == null || !cooldownVm.countdownLabel.includes("Try again in")) {
...
if (lockoutVm.countdownLabel == null || !lockoutVm.countdownLabel.includes("Try again in")) {
