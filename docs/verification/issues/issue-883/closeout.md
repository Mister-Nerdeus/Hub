...
- node scripts/check-manual-scenario-validation.mjs --stage final --issue 883
...
## Evidence Artifacts
- docs/verification/issues/issue-883/manual-scenario-validation-output.json
- docs/verification/issues/issue-883/scenario-reference-validation-fixture.json
