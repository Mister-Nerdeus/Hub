...
## Summary
Completed PIN-first entry gate stage: hide-shell-before-unlock.

## Files Changed
- See git diff for source changes and docs/verification/issues/issue-462 for local evidence.
...
## Evidence Artifacts
- docs/verification/issues/issue-462
