...
## Summary
Added operational-only simulation scoring derived from validated simulation run events and visible named assumptions.
...
## Known Limitations
No optimizer, staffing recommendation, clinical threshold, API, persistence, or UI was added by this issue.
