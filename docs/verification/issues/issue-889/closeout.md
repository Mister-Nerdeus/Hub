...
- docs/verification/issues/issue-889
...
## Evidence Artifacts
- docs/verification/issues/issue-889/manual-scenario-foundation-go-no-go-output.json
- docs/verification/issues/issue-889/split-room-unassigned-visual-state-output.json
- docs/verification/issues/issue-889/manual-scenario-staff-roster-contract-output.json
- docs/verification/issues/issue-889/manual-scenario-no-recommendation-guard-output.json
- docs/verification/issues/issue-889/scenario-contract-scan-output.json
- docs/verification/issues/issue-889/scenario-ui-copy-scan-output.json
- docs/verification/issues/issue-889/scenario-proof-artifact-scan-output.json
- docs/verification/issues/issue-889/manifest-update-output.json
- docs/verification/issues/issue-889/test-output/docker-compose-config.txt
- docs/verification/issues/issue-889/test-output/docker-compose-production-config.txt
- docs/verification/issues/issue-889/test-output/docker-compose-build-web.txt
- docs/verification/issues/issue-889/test-output/docker-compose-production-build-web.txt
