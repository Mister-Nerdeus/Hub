...
## Summary
Added an API-free optimizer proof surface showing candidates, neutral selected operational candidate, tie-breakers, audit trace, and limitations.
...
## Known Limitations
Local synthetic fixture only; no API, persistence, user-editable optimizer settings, export/download, or clinical recommendation was added.
