...
- node scripts/check-manual-scenario-contract.mjs --stage final --issue 882
...
## Evidence Artifacts
- docs/verification/issues/issue-882/manual-scenario-contract-output.json
- docs/verification/issues/issue-882/manual-scenario-fixture.json
- docs/verification/issues/issue-882/forbidden-scenario-fields-proof.json
