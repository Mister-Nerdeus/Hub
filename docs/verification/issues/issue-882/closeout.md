...
- node scripts/check-manual-scenario-snapshot-contract.mjs --stage final --issue 882
...
## Evidence Artifacts
- docs/verification/issues/issue-882/manual-scenario-snapshot-contract-output.json
- docs/verification/issues/issue-882/scenario-snapshot-fixture.json
- docs/verification/issues/issue-882/scenario-versioning-proof.json
- docs/verification/issues/issue-882/forbidden-scenario-snapshot-fields-proof.json
