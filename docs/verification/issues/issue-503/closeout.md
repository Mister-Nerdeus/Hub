...
## Summary
Completed unlocked workspace polish stage: lock-workspace-polish.
...
- node scripts/check-unlocked-workspace-polish.mjs --stage lock-workspace-polish --allow-partial --issue 503
...
## Evidence Artifacts
- docs/verification/issues/issue-503
