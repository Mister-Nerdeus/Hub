...
## Summary
- Completed Activity Profile Selector: Typical / Busy / Slammed within the internal synthetic dry-run boundary.

## Files Changed
- Simulation v0 repair source, gates, Docker/local verification wiring, manifest, and evidence artifacts as applicable for Issue 603.
...
## Evidence Artifacts
- docs/verification/issues/issue-603
