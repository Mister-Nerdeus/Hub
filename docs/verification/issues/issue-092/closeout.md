...
## Summary
Added a deterministic operational baseline optimizer that generates candidates, runs them through the assignment variant runner, and selects by visible score/tie-breakers.
...
## Known Limitations
Operational-only; no machine learning, clinical recommendation, safety claim, API, persistence, UI, or hidden scoring was added.
