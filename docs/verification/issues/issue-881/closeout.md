...
- node scripts/check-manual-scenario-staff-roster-contract.mjs --stage final --issue 881
...
## Evidence Artifacts
- docs/verification/issues/issue-881/manual-scenario-staff-roster-contract-output.json
- docs/verification/issues/issue-881/manual-scenario-staff-roster-fixture.json
- docs/verification/issues/issue-881/manual-scenario-staff-roster-forbidden-fields-proof.json
