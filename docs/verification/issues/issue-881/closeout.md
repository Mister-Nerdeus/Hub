...
- node scripts/check-co-assignment-policy-contract.mjs --stage final --issue 881
...
## Evidence Artifacts
- docs/verification/issues/issue-881/co-assignment-policy-contract-output.json
- docs/verification/issues/issue-881/co-assignment-validation-proof.json
- docs/verification/issues/issue-881/co-assignment-overlay-proof.json
