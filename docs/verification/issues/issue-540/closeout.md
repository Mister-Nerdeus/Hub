...
## Files Changed
- Canonical floorplan fidelity contracts, gates, docs, fixture, or evidence relevant to Issue 540.
...
- node scripts/check-default-plans-2-through-5-unchanged.mjs --issue 540
...
## Evidence Artifacts
- docs/verification/issues/issue-540
