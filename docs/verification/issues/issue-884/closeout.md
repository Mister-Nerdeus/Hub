...
- node scripts/check-manual-scenario-ui.mjs --stage final --issue 884
...
## Evidence Artifacts
- docs/verification/issues/issue-884/manual-scenario-ui-output.json
- docs/verification/issues/issue-884/screenshot-index.json
- docs/verification/issues/issue-884/screenshots/manual-scenario-ui.png
