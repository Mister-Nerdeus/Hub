...
- node scripts/check-manual-scenario-validation.mjs --stage final --issue 884
...
## Evidence Artifacts
- docs/verification/issues/issue-884/manual-scenario-validation-output.json
- docs/verification/issues/issue-884/scenario-reference-validation-fixture.json
