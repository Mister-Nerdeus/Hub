...
## Summary
- Completed Evidence Index Rebuild and Hard Gate within the internal synthetic dry-run boundary.

## Files Changed
- Simulation v0 repair source, gates, Docker/local verification wiring, manifest, and evidence artifacts as applicable for Issue 584.
...
## Evidence Artifacts
- docs/verification/issues/issue-584
