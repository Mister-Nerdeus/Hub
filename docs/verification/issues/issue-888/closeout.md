...
- docs/verification/issues/issue-888
...
## Evidence Artifacts
- docs/verification/issues/issue-888/manual-scenario-foundation-go-no-go-output.json
- docs/verification/issues/issue-888/manual-scenario-staff-roster-contract-output.json
- docs/verification/issues/issue-888/manual-scenario-no-recommendation-guard-output.json
- docs/verification/issues/issue-888/scenario-contract-scan-output.json
- docs/verification/issues/issue-888/scenario-ui-copy-scan-output.json
- docs/verification/issues/issue-888/scenario-proof-artifact-scan-output.json
- docs/verification/issues/issue-888/manifest-update-output.json
- docs/verification/issues/issue-888/test-output/docker-compose-config.txt
- docs/verification/issues/issue-888/test-output/docker-compose-production-config.txt
- docs/verification/issues/issue-888/test-output/docker-compose-build-web.txt
- docs/verification/issues/issue-888/test-output/docker-compose-production-build-web.txt
