...
Completed the geometry repair stage for Issue 425. GO for Issue 426.
...
- `node scripts/capture-geometry-repair-screenshots.mjs --issue 425`
- `node scripts/check-geometry-repair-tools.mjs --stage door-width-orientation --allow-partial --issue 425`
- `node scripts/check-default-plans-2-through-5-unchanged.mjs --issue 425`
...
- `docs/verification/issues/issue-425/commands.txt`
- `docs/verification/issues/issue-425/command-output-map.json`
- `docs/verification/issues/issue-425/test-output/geometry-repair-gate.txt`
- `docs/verification/issues/issue-425/manifest-update-output.json`
