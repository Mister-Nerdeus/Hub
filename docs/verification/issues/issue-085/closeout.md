...
## Summary
Added deterministic shortest-path travel time calculation over plan path graph data and explicit simulation travel option support.
...
## Known Limitations
No optimizer, UI path editor, real map integration, API, persistence, or clinical claim was added.
