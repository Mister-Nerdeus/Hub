...
## Summary
Added optimizer audit trail contract and builder with candidate score references and deterministic reconstruction.
...
## Known Limitations
No UI, API, persistence, PDF export, machine learning, or clinical recommendation was added.
