...
- docs/verification/issues/issue-817/

## Commands Run
- node scripts/check-geometry-root-script-completion.mjs --stage required-hardening-scripts --issue 817
...
## Evidence Artifacts
- docs/verification/issues/issue-817/test-output/check-geometry-root-script-completion.txt
- docs/verification/issues/issue-817/manifest-update-output.json
