...
## Files Changed
- Canonical floorplan fidelity contracts, gates, docs, fixture, or evidence relevant to Issue 548.

## Commands Run
- npm --workspace apps/web test
- npm --workspace apps/web run build
- node scripts/check-canonical-floorplan-scenario-readiness.mjs --stage final --issue 548
...
## Evidence Artifacts
- docs/verification/issues/issue-548
