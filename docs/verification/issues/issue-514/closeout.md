...
## Files Changed
- Canonical floorplan fidelity contracts, gates, docs, fixture, or evidence relevant to Issue 514.

## Commands Run
- npm --workspace packages/shared test
- npm --workspace apps/web test
- npm --workspace apps/web run build
- node scripts/check-room-bed-bay-model.mjs --stage split-bay-semantics --allow-partial --issue 514
...
## Evidence Artifacts
- docs/verification/issues/issue-514
