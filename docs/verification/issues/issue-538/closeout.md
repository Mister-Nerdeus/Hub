...
## Files Changed
- Canonical floorplan fidelity contracts, gates, docs, fixture, or evidence relevant to Issue 538.

## Commands Run
- node scripts/check-canonical-floorplan-scenario-readiness.mjs --stage path-door-consistency --allow-partial --issue 538
...
## Evidence Artifacts
- docs/verification/issues/issue-538
