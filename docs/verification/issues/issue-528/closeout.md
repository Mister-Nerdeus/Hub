...
## Files Changed
- Canonical floorplan fidelity contracts, gates, docs, fixture, or evidence relevant to Issue 528.

## Commands Run
- npm --workspace packages/shared test
- npm --workspace apps/web test
- npm --workspace apps/web run build
- node scripts/check-canonical-floorplan-fidelity.mjs --stage doors-access --allow-partial --issue 528
...
## Evidence Artifacts
- docs/verification/issues/issue-528
